...
export const UserProfileLoader: React.FC<UserProfileLoaderProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const fetchUserProfile = async () => {
      console.log('🔴 CLIENT STEP 3: UserProfileLoader fetching detailed profile...');
      ...
      console.log('🔴 CLIENT STEP 3: Profile loaded, recommendations can now load');
    ...
    <Box>
      <Box sx={{ mb: 2, p: 1, bgcolor: 'success.light', borderRadius: 1 }}>
        <Typography variant="body2">
          ✅ UserProfileLoader: Profile loaded - {userProfile?.favoriteCategories?.join(', ')}
        </Typography>
      </Box>
